...
if __name__ == '__main__':
    ...
    key_file = '/Users/shangjiuyue/Desktop/NEU/5330/final/WildfireSpreadTSCreateDataset/silicon-cell-471722-a4-d5a3da747c8b.json'

    # : Enter your gcloud service account here.
    service_account = 'fire-flow@silicon-cell-471722-a4.iam.gserviceaccount.com'
    credentials = ee.ServiceAccountCredentials(service_account, key_file)
    ee.Initialize(credentials)

    img = ee.ImageCollection("NASA/VIIRS/002/VNP09GA").first()
